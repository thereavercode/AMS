        ...
        <table class="table sakotable table-bordered table-striped dt-responsive">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td><a class="btn btn-success ams_btn_special" data-toggle="tooltip" href="javascript:;" onClick="$('#nurse_view_<?php echo $row['eid']; ?>').modal('show');" data-original-title="<?php echo $_data['view_text'];?>"><i class="fa fa-eye"></i></a> <a class="btn btn-warning ams_btn_special" data-toggle="tooltip" href="<?php echo WEB_URL;?>employee/addemployee.php?id=<?php echo $row['eid']; ?>" data-original-title="<?php echo $_data['edit_text'];?>"><i class="fa fa-pencil"></i></a> <a class="btn btn-danger ams_btn_special" data-toggle="tooltip" onClick="deleteEmployee(<?php echo $row['eid']; ?>);" href="javascript:;" data-original-title="<?php echo $_data['delete_text'];?>"><i class="fa fa-trash-o"></i></a>
                  ...
                  <div class="modal-dialog">
                    <div class="modal-content">
                      ...
                      <div class="modal-body">
                        ...
                        <div class="row">
                          <div class="col-xs-6"> <b><?php echo $_data['add_new_form_field_text_1'];?> :</b> <?php echo $row['e_name']; ?><br/>
                            <b><?php echo $_data['add_new_form_field_text_2'];?> :</b> <?php echo $row['e_email']; ?><br/>
                            <b><?php echo $_data['add_new_form_field_text_3'];?> :</b> <?php echo $converter->decode($row['e_password']); ?><br/>
                            ...
                            <b><?php echo $_data['add_new_form_field_text_6'];?> :</b> <?php echo $row['e_per_address']; ?><br/></div>
                            <div class="col-xs-6"><b><?php echo $_data['add_new_form_field_text_7'];?> :</b> <?php echo $row['e_nid']; ?><br/>
							...
							<b><?php echo $_data['add_new_form_field_text_16'];?> :</b> <?php echo $row['ending_date']; ?><br/>
							<b><?php echo $_data['add_new_form_field_text_11'];?> :</b> <?php if($row['e_status']=='1'){echo 'Active';}else{echo 'Inactive';}; ?><br/>
							<b><?php echo $_data['employee_salary'];?> : </b> <?php echo $ams_helper->currency($localization, $row['salary']); ?><br/>
                          </div>
                        </div>
                      </div>
                    </div>
...
function deleteEmployee(Id){
  	var iAnswer = confirm("<?php echo $_data['employee_confirm_delete_msg']; ?>");
	if(iAnswer){
